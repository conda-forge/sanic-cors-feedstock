...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sanic-cors-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11618&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sanic-cors-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sanic-cors` can be installed with:

```
conda install sanic-cors
```

It is possible to list all of the versions of `sanic-cors` available on your platform with:
